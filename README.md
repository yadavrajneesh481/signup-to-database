...
3. **Start the server:**
   ...
   ```
4. **Open your browser:**
   Visit [📝 Visit http://localhost:3000 to see the form](http://localhost:3000)
   Vist [👥 Visit http://localhost:3000/users to see all submissions](http://localhost:3000/users)
