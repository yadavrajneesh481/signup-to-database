...
3. **Start the server:**
   ...
   ```
4. **Open your browser:**
   Visit to see the form [📝 Visit http://localhost:3000 ](http://localhost:3000)
   Vist to see all submissions[👥 Visit http://localhost:3000/users ](http://localhost:3000/users)
